...
import com.example.vkrapplication.api.student.StudentsViewModel
...
@AndroidEntryPoint
class CourseStudentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView = findViewById(R.id.recycler_view_course_student)
        ...
        studentsViewModel.getStudentCourses(object: CoroutinesErrorHandler {
            override fun onError(message: String) {
                Toast.makeText(this@CourseStudentActivity, message, Toast.LENGTH_SHORT).show()
            }
        })

        studentsViewModel.coursesResponse.observe(this){
            when(it){
        ...
        courseAdapter.onItemClick = {
            val intent = Intent(this, StudentLessonActivity::class.java)
