...
import kotlinx.android.synthetic.main.activity_lesson_presentation.*
import kotlinx.android.synthetic.main.nav_header.*

@AndroidEntryPoint
class LessonPresentationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lesson_presentation)

        mainViewModel.getUserInfo(
            object: CoroutinesErrorHandler {
                override fun onError(message: String) {
                    Toast.makeText(this@LessonPresentationActivity, message, Toast.LENGTH_SHORT).show()
                }
            })
        ...
        webViewSetup("https://view.officeapps.live.com/op/embed.aspx?src=${lessonInfo?.presentationUrl}")

        val lectBtn = findViewById<Button>(R.id.lecture_btn)

        lectBtn.setOnClickListener {
            val intent = Intent(this, LessonLectureActivity::class.java)
    ...
    private fun webViewSetup(url : String){
        presentation_webview.webViewClient = WebViewClient()

        presentation_webview.apply {
            loadUrl(url)
